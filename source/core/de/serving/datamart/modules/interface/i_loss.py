...
from ..utils import METHODS_MAP, is_cols_available, execute_sql_query, merge_df_with_dm
from . import IBasic
...
class ILostDemand(IBasic):
    ...
    def process(self) -> None:
        logger.info('Обработка упущенного спроса;')
    ...
    def add_lost_demand(
        ...
        sql_method = METHODS_MAP["ld"]["lost_demand"]
