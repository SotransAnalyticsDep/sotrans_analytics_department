...
class IExpend(IBasic):
    ...
    def add_complect(
        ...
        sql_method = METHODS_MAP["ex"]["complect"]
    ...
    def add_inventory(
        ...
        # Получение метода формирования SQL-запроса
        sql_method = METHODS_MAP["ex"]["inventory"]
    ...
    def add_movement(
        ...
        # Получение метода формирования SQL-запроса
        sql_method = METHODS_MAP["ex"]["movement"]
    ...
    def add_resort(
        ...
        # Получение метода формирования SQL-запроса
        sql_method = METHODS_MAP["ex"]["resort"]
    ...
    def add_sale(
        ...
        # Получение метода формирования SQL-запроса
        sql_method = METHODS_MAP["ex"]["sale"]
    ...
    def add_update(
        ...
        # Получение метода формирования SQL-запроса
        sql_method = METHODS_MAP["ex"]["update"]
    ...
    def add_write_off(
        ...
        # Получение метода формирования SQL-запроса
        sql_method = METHODS_MAP["ex"]["write_off"]
